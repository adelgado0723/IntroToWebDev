...
},{}],"modal.08f03648.js":[function(require,module,exports) {
var define;
...
parcelRequire = function (modules, cache, entry, globalName) {
  ...
  "node_modules/style-value-types/dist/style-value-types.es.js": [function (require, module, exports) {
    ...
    ***************************************************************************** */
    ...
    var alpha = _assign2({}, number, {
      transform: clamp(0, 1)
    });

    exports.alpha = alpha;

    var scale = _assign2({}, number, {
      default: 1
    });
    ...
    var progressPercentage = _assign2({}, percent, {
  ...
  "node_modules/hey-listen/dist/hey-listen.es.js": [function (require, module, exports) {
    ...
    if ("development" !== 'production') {
      exports.warning = warning = function warning(check, message) {
        if (!check && typeof console !== 'undefined') {
          console.warn(message);
        }
      };

      exports.invariant = invariant = function invariant(check, message) {
        if (!check) {
  ...
  "node_modules/framesync/dist/framesync.es.js": [function (require, module, exports) {
    ...
    "hey-listen": "node_modules/hey-listen/dist/hey-listen.es.js",
  ...
  "node_modules/@popmotion/popcorn/dist/popcorn.es.js": [function (require, module, exports) {
    ...
    ***************************************************************************** */
    ...
    var mixColor = function mixColor(from, to) {
      ...
      var blended = _assign3({}, fromColor);
    ...
    var mixObject = function mixObject(origin, target) {
      var output = _assign3({}, origin, target);
    ...
    "style-value-types": "node_modules/style-value-types/dist/style-value-types.es.js",
    "hey-listen": "node_modules/hey-listen/dist/hey-listen.es.js",
    "framesync": "node_modules/framesync/dist/framesync.es.js",
    "@popmotion/easing": "node_modules/@popmotion/easing/dist/easing.es.js"
  }],
  "node_modules/stylefire/dist/stylefire.es.js": [function (require, module, exports) {
    ...
    ***************************************************************************** */
    ...
    var rounded =
    /*#__PURE__*/
    _assign4({}, _styleValueTypes.number, {
  ...
  "node_modules/popmotion/dist/popmotion.es.js": [function (require, module, exports) {
    var process = require("process");
            ...
            return a.start({
              complete: function complete() {
                if (!hasCompleted) {
                  hasCompleted = true;
                  numCompletedActions++;
                  if (numCompletedActions === numActions) _framesync.default.update(_complete);
                }
              },
              error: error,
    ...
    var tween = function tween(props) {
      ...
      return action(function (_a) {
        ...
        var isTweenComplete = function isTweenComplete() {
          ...
          var isComplete = playDirection === 1 ? _isActive && elapsed >= duration : _isActive && elapsed <= 0;
    ...
    "@popmotion/popcorn": "node_modules/@popmotion/popcorn/dist/popcorn.es.js",
    "framesync": "node_modules/framesync/dist/framesync.es.js",
    "style-value-types": "node_modules/style-value-types/dist/style-value-types.es.js",
    "@popmotion/easing": "node_modules/@popmotion/easing/dist/easing.es.js",
    "stylefire": "node_modules/stylefire/dist/stylefire.es.js",
    "hey-listen": "node_modules/hey-listen/dist/hey-listen.es.js",
    "process": "../../../../AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js"
  }],
  "public/modal.js": [function (require, module, exports) {
    "use strict";
    ...
    var okModalButton = document.querySelector('.modal-ok');
    ...
    var tweenUp = function tweenUp(track) {
      ...
      return {
        ...
        ease: {
          y: _popmotion.easing.backOut,
          opacity: _popmotion.easing.linear
        }
      };
    };
    ...
    var openModal = function openModal() {
      ...
      }, '-100', tweenUp('modal'), '-200', [].concat(_toConsumableArray(modalSections.map(function (s, i) {
    ...
    "popmotion": "node_modules/popmotion/dist/popmotion.es.js"
  }],
...
}, {}, ["../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js", "public/modal.js"], null);
},{"process":"../../../../AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js"}]